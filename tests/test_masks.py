...
assert get_mask_account(11555510) == 0

@pytest.mark.parametrize('test_mask_card, positive_mask_card', [(7000792289606361, '7000 79** **** 6361'), (10000000000000000000, '1000 00** **** **** 0000'), (0, 0)])
